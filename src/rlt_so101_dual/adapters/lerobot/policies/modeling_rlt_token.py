"""RL Token LeRobot policy (Stage B)."""
...
class RLTokenPolicy(PreTrainedPolicy):
    ...
    def _load_pi05_backbone(self) -> PI05Policy:
        ...
        # Stock PI05Policy.from_pretrained peaks ~26GB RSS on this box (fp32
        # construct + full safetensors dict) and gets OOM-killed. Low-mem path
        # builds in bf16 and streams weights.
