...
from rlt_so101_dual.adapters.lerobot.policies.action_modifier import (
    PrefixOutputCapture,
    RLTActionModifier,
    RLTStepMetadata,
)
...
class RLTPretrainedPolicy(PreTrainedPolicy):
    ...
    def _ensure_pi05(self):
        ...
        from rlt_so101_dual.adapters.lerobot.policies.pi05_low_mem import load_pi05_policy_low_mem
        ...
        pi05_config.device = cfg.device or "cuda"

        pi05 = load_pi05_policy_low_mem(
    ...
    def forward(self, batch: dict[str, Tensor]) -> tuple[Tensor, dict | None]:
        raise NotImplementedError(
            ...
            "Use rlt_so101_dual.core.trainer for demo adaptation / offline RL training."
        )
