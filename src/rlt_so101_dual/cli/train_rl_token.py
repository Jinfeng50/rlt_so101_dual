...
def main() -> None:
    ...
    from rlt_so101_dual.adapters.lerobot.demo_loader import make_demo_loader
    from rlt_so101_dual.core.trainer import demo_adaptation
