"""CLI: offline chunk actor-critic training."""
...
from rlt_so101_dual.cli.common import build_pi05_policy, configure_logging, load_training_config
...
def load_cached_replay_buffers(transition_cache_dir: str, capacity: int) -> tuple:
    from rlt_so101_dual.adapters.lerobot.offline_dataset import load_transition_cache
...
def build_live_replay_buffers(policy, args: argparse.Namespace, config) -> tuple:
    from rlt_so101_dual.adapters.lerobot.offline_dataset import build_transition_replay_buffer
...
def create_algorithm_with_cached_transitions(config, rl_token_checkpoint: str | None, device: str):
    ...
    from rlt_so101_dual.core.vla_adapter import DummyVLAAdapter
...
def main() -> None:
    ...
    from rlt_so101_dual.core.evaluator import evaluate_offline
    from rlt_so101_dual.core.trainer import offline_rl_loop
